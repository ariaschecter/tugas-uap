        ...
        <ul class="sidebar-menu">
            ...
            <li class="">
                <a href="javascript:void(0)" class="navItem">
                    <span class="flex items-center">
                        <iconify-icon class="nav-icon" icon="heroicons-outline:rectangle-stack"></iconify-icon>
                        <span>Distance</span>
                    </span>
                ...
                <ul class="sidebar-submenu">
                  <li class="">
                    <a href="{{ route('admin.distance.index') }}" class="{{ $route == 'admin.distance.index' ? 'active' : '' }}">All distance</a>
                  </li>
                  <li class="">
                    <a href="{{ route('admin.distance.create') }}" class="{{ $route == 'admin.distance.create' ? 'active' : '' }}">Add distance</a>
                  </li>
                </ul>
              </li>
